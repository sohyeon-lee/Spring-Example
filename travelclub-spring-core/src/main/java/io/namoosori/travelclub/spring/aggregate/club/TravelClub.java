...
public class TravelClub extends Entity {
	private static final int MINIMUM_NAME_LENGTH =  3;		// 클럽 명 최소 길이
	private static final int MINIMUM_INTRO_LENGTH =  10;	// 클럽 소개 최소 길이

	private String name;			// 클럽 명
	private String intro;			// 클럽 소개
	private long foundationTime;	// 클럽 생성시간
